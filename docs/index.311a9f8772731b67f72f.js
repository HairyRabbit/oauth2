...
module.exports = {"main":"_1ueqD-P2i1LvWLBvoe7zDS","placeholder":"_3B0Zi8LfdprJwVzr44WvFA","row":"_1CznXctYRNFS72UDWyOjsz","header":"_2Pmc4Ak32Rj3cqgC3FSF-G","logo":"_3kUYiq7dPbIOOo_9upfCBL","input":"_2-K5DBwRIoc0Wu4-n5y-nt","title":"_1LPrGkNutQGOf2WzYxO09w","group":"-ahzdeZuB1OtBsY52PmL4","button":"S7uF3ZZNvUd8TO7u0Nmqj","icon":"_2oV5ZFOWIc3hq-5QeAm7pd","qq":"-__2LrS-b2Cm7J_a5GNEZ","weibo":"_2YyQy89Ws7puRC6q04mBlh","weixin":"_3TZ-heIdsDS71dXDmGV1h2","btn":"_73o_yS034dWOoZEP_5TjG"};
...
// CONCATENATED MODULE: ./src/icon/qq.js
...
function Weixin(props) {
  return react["createElement"]("svg", weixin_extends({}, props, {
...
// CONCATENATED MODULE: ./src/icon/weibo.js
function weibo_extends() { weibo_extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return weibo_extends.apply(this, arguments); }
...
const demo_top = (window.screen.height - 600) / 2;
const left = (window.screen.width - 800) / 2;
const [base, from] =  false ? undefined : ['oauth2', '/oauth2'];

function demo_open(typ, qs = '', jump = false) {
  return function open1() {
    if (!jump) {
      const popup = window.open(`${base}?typ=${typ}${qs}`, 'OAuth2 login', `resizable,width=800,height=600,top=${demo_top},left=${left},location=0`);
      window.addEventListener("message", function (evt) {
        console.log(evt);
        popup.close();
      }, false);
    } else {
      location.href = `${base}?typ=${typ}${qs}&from=${from}`;
    }
  };
}
...
if (!node) {
  throw new Error(`Mount node named ${mount} can't find`);
}

const App = () => react["createElement"](react["Fragment"], null, react["createElement"]("div", {
  className: style_default.a.main
}, react["createElement"]("div", {
  className: style_default.a.placeholder
}, react["createElement"]("div", {
  className: style_default.a.header
}, react["createElement"]("div", {
  className: style_default.a.logo
})), react["createElement"]("div", {
  className: style_default.a.row
}, react["createElement"]("div", {
  className: style_default.a.input
})), react["createElement"]("div", {
  className: style_default.a.row
}, react["createElement"]("div", {
  className: style_default.a.input
...
}, "Community Account Login"), react["createElement"]("div", {
  className: style_default.a.group
}, react["createElement"]("button", {
  className: [style_default.a.button, style_default.a.weibo].join(' '),
  onClick: demo_open('weibo')
}, react["createElement"](Weibo, {
  className: style_default.a.icon
})), react["createElement"]("button", {
  className: [style_default.a.button, style_default.a.weixin].join(' '),
  onClick: demo_open('weixin')
}, react["createElement"](Weixin, {
  className: style_default.a.icon
})), react["createElement"]("button", {
  className: [style_default.a.button, style_default.a.qq].join(' '),
  onClick: demo_open('qq')
}, react["createElement"](QQ, {
  className: style_default.a.icon
})))), react["createElement"]("div", {
  className: style_default.a.main
}, react["createElement"]("div", {
  className: style_default.a.title
}, "More Control"), react["createElement"]("button", {
  className: style_default.a.btn,
  onClick: demo_open('qq', '&lang=en')
}, "I18n: EN"), react["createElement"]("button", {
  className: style_default.a.btn,
  onClick: demo_open('qq', '&lang=en&fetch=client')
}, "Handle connect error"), react["createElement"]("button", {
  className: style_default.a.btn,
  onClick: demo_open('qq', '&lang=en&fetch=runtime')
}, "Handle server error"), react["createElement"]("button", {
  className: style_default.a.btn,
  onClick: demo_open('qq', '&lang=en&mode=redirect', true)
}, "Redirect and back")));

Object(react_dom["render"])(react["createElement"](App, null), node);
...
function Na(a) {
  ...
  for (; !a[C];) if (a.parentNode) a = a.parentNode;else return null;
    ...
    if (a.source === window && a.data === te && (ne = !1, null !== L)) {
      if (null !== L) {
        ...
        if (!(-1 === me || me > b)) {
          ...
          if (0 < c.length) for (se.didTimeout = !0, b = 0, d = c.length; b < d; b++) ue(c[b], se);
          me = a;
        }
      }
...
function Gg(a) {
  ...
  var b = a.type;
  if (5 !== a.tag || "head" !== b && "body" !== b && !df(b, a.memoizedProps)) for (b = Ag; b;) Cg(a, b), b = hf(b);
  Fg(a);
...
function Yh(a, b, c) {
  Ph = c;
  Xh();
  if (b) for (; null !== X && 0 !== Y && (0 === a || a >= Y) && (!Mh || mg() >= Y);) mg(), Vh(X, Y, !Mh), Xh();else for (; null !== X && 0 !== Y && (0 === a || a >= Y);) Vh(X, Y, !1), Xh();
